...
public class TaskController {
    ...
    // TODO Починить отображение Swagger-а -- чтобы параметры в Get запросах нормально воспринимал
    ...
    @GetMapping("/")
    public DeferredResult<TaskSearchResponse> getPaging(@Parameter(in = ParameterIn.QUERY, required = true,
